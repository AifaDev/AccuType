...
export default function Keyboard({ ...props }) {
  return (
    <div {...props}>
      <div className="w-[898.62px] h-[302.13px] bg-gray-200 flex flex-col gap-1 p-1">
...
const Key = ({ value, alt, grow }) => {
  ...
  return (
    <div
      className={`h-full w-14 text-center flex flex-col justify-center gap-1 ${
        value == clicked ? "bg-green-300 " : "bg-white"
      } ${grow && "flex-grow"}`}
    >
